...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference("Option.count") do
      post options_url, params: { option: { armymax: @option.armymax, cgmax: @option.cgmax, description: @option.description, name: @option.name, tv: @option.tv, type: @option.type } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { armymax: @option.armymax, cgmax: @option.cgmax, description: @option.description, name: @option.name, tv: @option.tv, type: @option.type } }
