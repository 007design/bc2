class AttributeTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @attribute_type.save
        format.html { redirect_to attribute_type_url(@attribute_type), notice: "Attribute type was successfully created." }
  ...
  def update
    respond_to do |format|
      if @attribute_type.update(attribute_type_params)
        format.html { redirect_to attribute_type_url(@attribute_type), notice: "Attribute type was successfully updated." }
  ...
  private
    ...
    def attribute_type_params
      params.require(:attribute_type).permit(:name)
    end
end
